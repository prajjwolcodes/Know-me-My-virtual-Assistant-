   ...
   <div className="min-h-screen bg-[#212121] px-2 sm:px-4 md:px-6 lg:px-8 py-1 text-[#F3F3F3]">
      ...
      >
        <div className="w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-3xl overflow-y-auto max-h-[calc(100vh-200px)] scroll-container">
          ...
          {messages.length === 0 && (
            <div className="fixed bottom-18 md:static left-2 right-2 sm:left-4 sm:right-4 md:left-0 md:right-0 w-auto md:w-full flex flex-wrap justify-center gap-2 sm:gap-2 mb-4 px-2 md:px-2">
          ...
          <div className="relative">
            <div
              className={`${
                messages.length > 0
                  ? "chat-input fixed bottom-4 sm:bottom-6 px-2 py-2 right-2 left-2 sm:w-4/5 md:w-3/4 lg:w-2/3 xl:w-1/2"
                  : "px-3 py-3 md:px-3 sm:px-4 md:py-4 sm:py-6"
              } flex fixed bottom-6 left-4 right-4 items-center bg-[#303030] rounded-2xl sm:rounded-4xl`}
            >
              <input
                ref={inputRef}
                value={inputValue}
                ...
                className="flex-1 bg-transparent text-white placeholder-gray-400 outline-none px-1 dm:px-4 dm:py-3 text-sm sm:text-base"
              />
              ...
              <div className="flex items-center gap-2 ml-2 sm:ml-3">
                <Button
                  ...
                  } hover:bg-gray-300 rounded-full h-7 w-7 sm:h-8 sm:w-8`}
                  onClick={handleSend}
