...
async function getAnswer(question) {
  ...
  const contextChain = RunnableSequence.from([templatePrompt, model, new StringOutputParser(), retriever, combineDocuments])
  const answerChain = RunnableSequence.from([answerTemplatePrompt, model, new StringOutputParser()])
